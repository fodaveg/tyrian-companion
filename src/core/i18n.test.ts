...
const H5_11_KEYS = [
	...
	'advisor.view.groupNone', 'advisor.view.noValueGroup.one', 'advisor.view.noValueGroup.many',
	'advisor.view.qty.reserved', 'advisor.view.recommendationTitle', 'advisor.view.tableCaption', 'advisor.view.storage.name.bagsFor',
	...
	'advisor.view.burden.retained', 'advisor.view.burden.unclassified', 'advisor.view.burden.value',
	'advisor.view.protection.goal', 'advisor.view.protection.goalValue',
	'advisor.view.protection.exception', 'advisor.view.protection.exceptionValue',
	'advisor.view.marketComparison.instant', 'advisor.view.marketComparison.listing',
	'advisor.view.marketComparison.difference', 'advisor.view.marketComparison.differenceValue',
	'advisor.view.marketDepth.status', 'advisor.view.marketDepth.status.complete',
	'advisor.view.marketDepth.status.partial', 'advisor.view.marketDepth.status.no_market',
	'advisor.view.marketDepth.status.error', 'advisor.view.marketDepth.coverage',
	'advisor.view.marketDepth.coverageValue',
	...
	'advisor.view.reason.rule_stale', 'advisor.view.reason.knowledge_stale', 'advisor.view.reason.rule_conflict',
	...
	'advisor.view.reason.delete_warning',
