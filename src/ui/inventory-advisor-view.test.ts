...
function twoRouteDisclosure(): NonNullable<InventoryAdvisorViewRow['containerEconomy']> {
	...
	const immediate = {
		...
		open: { evPerContainerMicroCopper: 207_551_877, totalExpectedMicroCopper: '207551877',
		...
		comparison: { differenceMicroCopper: '-126848123', advantageBps: -3_172,
			rule: 'open_at_or_above_threshold' as const },
		decision: { action: 'sell' as const, sellRoute: 'instant_sell' as const },
		openIncludingTail: { evPerContainerMicroCopper: 286_126_446, totalExpectedMicroCopper: '286126446',
