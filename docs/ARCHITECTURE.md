...
raíz portable derivada de `managedAssetsRoot ?? outputFolder`, verifica marker, schema, relación de
ruta y hash de bytes, y produce pasos create/update/unchanged/deactivate/conflict sin escribir. Apply
