...
| Contaminación o duplicación de alertas | Solo una sesión Halloween aceptada habilita vivo. Polling y final comparten `session:<id>`, cola y sello terminal; el final sustituye atómicamente la evidencia provisional y un vuelo tardío no puede reaparecer. Seen, episode, terminal y meta validan scope/version/payload. El backfill reutiliza el inspector durable y hashes gestionados. | Episodios distintos pueden alertar de nuevo deliberadamente. Un Vault ilegible o una v3 inválida detiene el aprendizaje en vez de inventar cobertura. |
