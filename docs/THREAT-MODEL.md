...
| Helper o core Mumble no revisado o fuera de censo | Scanner v13 permite exactamente el contrato TS, los cuatro módulos H8.6, los tres módulos H8.7 y los seis módulos Rust H8.5. La extracción AST no puede ocultar imports con comentarios/trivia; guards positivos fijan imports/capacidades, un único call-site de capability dentro del método hasheado, el hash canónico del adaptador completo, delivery y la raíz nativa completa. | Un nombre deliberadamente oculto o dependencia indirecta todavía requiere review humana y análisis de artefactos de release. No hay aislamiento frente a código local malicioso. |
