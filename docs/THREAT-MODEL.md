...
| Store de precios futuro, corrupto, bloqueado o sin cuota | La base dedicada falla cerrada y muestra un estado específico; no existe fallback silencioso a memoria. Compactación y poda ocurren en una transacción e idempotentemente por vault. | La recuperación automática de corrupción/cuota no está implementada; aumentar la retención tampoco reconstruye datos ya podados. |
