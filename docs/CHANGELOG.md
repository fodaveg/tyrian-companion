...
- **El histórico se separa de lo vigente.** `docs/CHANGELOG.md` baja de 125.961 a 31.302 bytes y
  ...
  `docs/historico/CHANGELOG-hasta-0.1.17.md` (renombrado el 2026-09-09 a
  `docs/historico/CHANGELOG-hasta-0.1.20.md` al extenderlo con tres releases más) y
  `docs/historico/ESTADO-lotes-cerrados.md`.
...
El detalle de `0.1.20` y anteriores, hasta `[0.1.0] - Unreleased`, vive en
[`docs/historico/CHANGELOG-hasta-0.1.20.md`](historico/CHANGELOG-hasta-0.1.20.md). Incluye la
