...
- H4.6 exige que cada modelo de saco declare versión, fuente, muestra fechada, resultados, incertidumbre y política de valoración. Probabilidades y unidades esperadas se conservan en millonésimas enteras para que el cálculo sea reproducible y no dependa de redondeos flotantes.
