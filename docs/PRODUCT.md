...
- H4.14 ya captura manualmente la evidencia completa de esa superficie: catálogo para cada item propio,
  ...
  de rutas, reservas y excepciones; H5.11-H5.12 permanecen pendientes.
...
- UI, persistencia o ejecución de recomendaciones e intenciones; H4.10–H4.13 solo entregan decisiones, planes, contratos y envelopes manuales puros.
