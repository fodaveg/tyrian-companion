...
- H4.14 ya captura manualmente la evidencia completa de esa superficie: catálogo para cada item propio,
  ...
  Sigue sin clasificar, recomendar, persistir o mostrar una interfaz; H4.15-H4.16/H5.11-H5.12 permanecen pendientes.
