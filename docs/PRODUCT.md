...
- H5.6 ofrece Preview, Apply, Repair, Move y Remove para un bundle genérico de assets. No escanea el vault ni escribe al cargar; manifiesto, hashes y journal impiden adjudicarse o sobrescribir un fichero humano. Esta fase registra una Base neutral y deja el contenido de Halloween para H5.7.
