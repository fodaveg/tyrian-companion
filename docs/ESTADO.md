...
5. Implementar H3.3 parada manual con snapshot final cercado y clasificación provisional.
...
8. Hacer QA manual de H3.2 en dos ventanas y, si Obsidian comparte el origin, dos procesos reales: doble clic, reload, cierre forzado y pérdida/recovery del lease.
