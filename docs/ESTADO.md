...
**Foundation, conexión GW2, `storage_snapshot`, H2.4 `PublicCatalog`, H2.6 `storage_delta` y H2.7 contaminación: implementados.**
...
- `npm run test`: 16 ficheros y 265 tests verdes.
